...
import { catalogueFacts } from '@/content/catalogues'
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  /** every entry lists all eight languages so crawlers pair them up */
  const entry = (
  ...
  return [
    ...
    ...catalogueFacts.flatMap((c) => entry((l) => routes.catalogue(l, c.slug), 0.7, 'yearly')),
